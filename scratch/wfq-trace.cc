...
main (int argc, char *argv[])
{
  ...
  // LogComponentEnable ("WfqDisc", LOG_LEVEL_INFO);
  ...
  Config::SetDefault ("ns3::DRRQueueDisc::ByteLimit", UintegerValue (1000000 * 1024));   //WTF?
  Config::SetDefault ("ns3::DRRQueueDisc::Flows", UintegerValue (8));
  ...
  tchWFQ.SetRootQueueDisc ("ns3::WfqDisc");
  tchWFQ.AddPacketFilter (handle, "ns3::WFQIpv4PacketFilter");
  ...
  // std::cout << "====================3" << std::endl;
  queueDiscs = tchWFQ.Install (routerDevices.Get (10));
// std::cout << "====================4" << std::endl;
...
//     }
  ...
  p2p.EnableAsciiAll (ascii.CreateFileStream ("/home/guolab/LFS/NS3/wfq-router.tr"));
