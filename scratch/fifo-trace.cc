...
NS_LOG_COMPONENT_DEFINE ("FifoExample");
...
main (int argc, char *argv[])
{
  ...
  TrafficControlHelper fifoTch;
  fifoTch.SetRootQueueDisc ("ns3::FifoQueueDisc", "MaxSize",
                         StringValue ("10000p"));
  ...
  // std::cout << "====================3" << std::endl;
  queueDiscs = fifoTch.Install (routerDevices);
// std::cout << "====================4" << std::endl;
...
// std::cout << "====================3" << std::endl;
  ...
  incomePacketTraceStream = ascii.CreateFileStream ("/home/guolab/LFS/NS3/fifo-router-income.csv");
  outcomePacketTraceStream = ascii.CreateFileStream ("/home/guolab/LFS/NS3/fifo-router-outcome.csv");
