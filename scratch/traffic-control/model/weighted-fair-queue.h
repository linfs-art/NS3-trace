...
struct CompareFinishTime {
    bool operator()(QueueItemAlter const & qi1, QueueItemAlter const & qi2) {
...
private:
	...
	std::priority_queue<QueueItemAlter, std::vector<QueueItemAlter>, CompareFinishTime> m_wfqPQ;
